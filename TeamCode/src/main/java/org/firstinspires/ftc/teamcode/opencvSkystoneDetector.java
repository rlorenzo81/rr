...
import org.firstinspires.ftc.teamcode.drive.opmode.MyStandardTrackingWheelLocalizer;
...
import org.openftc.easyopencv.OpenCvCamera.*;
import org.openftc.easyopencv.R.*;
import com.acmerobotics.roadrunner.geometry.Pose2d;
import com.acmerobotics.roadrunner.trajectory.Trajectory;
import com.qualcomm.robotcore.eventloop.opmode.Autonomous;
import com.qualcomm.robotcore.eventloop.opmode.LinearOpMode;
    ...
    public void runOpMode() throws InterruptedException {
      ...
      // phoneCam = new OpenCvInternalCamera(OpenCvInternalCamera.CameraDirection.BACK, cameraMonitorViewId);//remove this
        ...
        while (opModeIsActive()) {
            ...
            {
                //get stone in center, 2nd from right
            }
            ...
            else if(+valLeft ==255 && +valMid == 255 && +valRight ==255 )
            {
                //get a lot of stones
            }
