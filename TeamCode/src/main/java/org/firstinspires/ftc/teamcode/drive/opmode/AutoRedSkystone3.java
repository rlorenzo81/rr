...
public class AutoRedSkystone3 extends LinearOpMode {
...
//run to right most stone
        ...
        Trajectory traj = drive.trajectoryBuilder(new Pose2d(-42.75,-53.5, Math.toRadians(90)))
                .splineTo(new Pose2d(-45.5, -28, 0))
                .build();
        //Lines up back claw w/ the skystone in 3nd place
        ...
        drive.followTrajectory(
                drive.trajectoryBuilder(new Pose2d(48, -25, Math.toRadians(180)), 0)
                        ...
                        .splineTo(new Pose2d(-69,-29.5, Math.toRadians(180)))
                        .build()
                //Lines up back claw w/ 3rd skystone pair
        );
